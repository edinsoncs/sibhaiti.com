...
<div class="tab-pane <?php echo $active_tab == 'eleveurs_edit' ? 'active' : NULL; ?>" id="tab_eleveurs_edit">
    <form action="" method="post" name="eleveurs_edit" class="form-horizontal">
        <div class="user-form">
            ...
            {
                ?>
                <p class = "information"><?php echo $user->finduser(array_get($edit_item, 'desc')); ?> kreye elvè saa nan dat kite: 
                    <?php echo substr(array_get($edit_item, 'created_at'), 0, strrpos(array_get($edit_item, 'created_at'), ' ')); ?>
                    . Denye dat enfòmasyon sou elvè sa a modifye se: 
    ...
    <label class="col-lg-2 control-label">Crée le: </label>
...
<div class="form-group">
    <label class="col-lg-2 control-label">Par: </label>
    <div class="col-lg-5" style="margin-top: 5px">
            <?php echo $user->finduser(array_get($edit_item, 'desc')); ?>
        <span class="help-inline"></span>
    </div>
</div>
<div class="form-group">
    <label class="col-lg-2 control-label">Dernière modification: </label>
    <div class="col-lg-5" style="margin-top: 5px">
            <?php echo substr(array_get($edit_item, 'updated_at'), 0, strrpos(array_get($edit_item, 'updated_at'), ' ')); ?>
        <span class="help-inline"></span>
    </div>
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label" for="edit_eleveur_department_1"><?php echo Lang::get('Depatman'); ?><span class="req">*</span></label>
                <div class="col-lg-5">
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label" for="edit_eleveur_city"><?php echo Lang::get('Komin'); ?><span class="req">*</span></label>
                <div class="col-lg-5">
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label" for="edit_eleveur_cSection"><?php echo Lang::get('Seksyon'); ?><span class="req">*</span></label>
                <div class="col-lg-5">
            ...
            <legend>Nimewo cin Elvè a</legend>
            <div class="form-group">
                ...
                <div class="col-lg-offset-2 col-lg-10">
                    ...
                    if ($user->role != 'user')
                    {
                        ...
                        <button type="submit" class="btn btn-primary" name="edit[submit]">
                            <?php echo Lang::get('Modifye Elvè a'); ?>
                        </button>
                        <?php
                    }
                    ?>
