    ...
    <form action="" method="post" name="agents_create" class="form-horizontal">
        ...
        <div class="user-form">
			...
			<div class="form-group">
                ...
                <div class="col-lg-5">
                    <input name="create[agent][phone]" id="create_agent_phone" class="form-control" maxlength="9" type="phone" placeholder="<?php echo Lang::get('3634-4098'); ?>" >
                    <span class="help-inline"></span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input name="create[agent][phone2]" id="create_agent_phone2" class="form-control" maxlength="9" type="phone" placeholder="<?php echo Lang::get('3634-0000'); ?>" >
                    <span class="help-inline"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input name="create[agent][so]" id="create_agent_so" class="form-control" maxlength="7" type="text" placeholder="<?php echo "HTI1234"; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input id="so2" class="form-control" type="text" placeholder="<?php echo "HTI-1234"; ?>" maxlength="8"/>
