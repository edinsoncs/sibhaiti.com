        ...
        <div class="user-form">
           ...
           <legend>ENFÒMASYON AK ADRÈS PWEN ABATAJ LA</legend>
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_name">
                non pwen abataj la<span class="req">*</span></label>

                <div class="col-lg-5">

                    <input name="create[abattoir][name]" id="create_abattoir_name" class="form-control" type="text" placeholder="non pwen abataj la">
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_type">
				<?php echo Lang::get('Tip'); ?><span class="req">*</span></label>
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_department_1">
				<?php echo Lang::get('Depatman'); ?><span class="req">*</span></label>
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_city">
				<?php echo Lang::get('Komin'); ?><span class="req">*</span></label>
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_cSection">
				<?php echo Lang::get('Seksyon'); ?></label>
...
<div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_owner">Responsab<span class="req">*</span></label>

                <div class="col-lg-5">

                    <input name="create[abattoir][owner]" id="create_abattoir_owner" class="form-control" type="text" placeholder="Responsab">
            ...
            <div class="form-group">
                ...
                <label class="col-lg-3 control-label" for="create_abattoir_phone">
				<?php echo Lang::get('Telefòn'); ?></label>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <textarea name="create[abattoir][description]" id="create_abattoir_description" rows="5" class="form-control" placeholder="Remak"></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input name="create[abattoir][bef]" id="create_abattoir_bef" 
                    class="form-control" type="text" placeholder="bèf" maxlength="3" >
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input name="create[abattoir][kabri]" id="create_abattoir_kabri" class="form-control" type="text" placeholder="kabrit" maxlength="3">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input name="create[abattoir][mouton]" id="create_abattoir_mouton" class="form-control" type="text" placeholder="mouton" maxlength="3" >
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    ...
                    <input name="create[abattoir][kochon]" id="create_abattoir_kochon" class="form-control" type="text" placeholder="kochon" maxlength="3" >
