...
@include('admin.abattoirs.tab_top')
<div class="tab-pane <?php echo $active_tab == 'abattoirs_edit' ? 'active' : NULL; ?>" id="tab_abattoirs_edit">
    <form action="" method="post" name="abattoirs_edit" class="form-horizontal">
        <div class="user-form">
            ...
            ?>
            <legend>Enfòmasyon ak adrès pwen abataj la</legend>            <h4>Silvouplè, ranpli tout chan ki gen <span class="req">*</span></h4>
 <div class="form-group">                <label class="col-lg-3 control-label" for="edit_abattoir_name">Non pwen abataj la<span class="req">*</span></label>                <div class="col-lg-5">                    <input name="edit[abattoir][name]" id="edit_abattoir_name" class="form-control" type="text" placeholder="Non pwen abataj la" value="<?php echo array_get($edit_item, 'name'); ?>" maxlength="20" />                    <span class="help-inline"></span>                </div>            </div>            <div class="form-group">                <label class="col-lg-3 control-label" for="edit_abattoir_type"><?php echo Lang::get('Tip'); ?><span class="req">*</span></label>                <div class="col-lg-5">                    
 ...
 <select name="edit[abattoir][type]" id="edit_abattoir_type" class="form-control" >
                      ...
                      <option value="public-isole" <?php echo (array_get($edit_item, 'type') == 'public-isole') ? 'selected="selected"' : NULL; ?>>Piblik (Izole)</option>
                        ...
                        <option value="ong" <?php echo (array_get($edit_item, 'type') == 'ong') ? 'selected="selected"' : NULL; ?>>Ong</option>                 
                         ...
                         </select>                    <span class="help-inline"></span>                </div>            </div>
            ...
            </div>						            <div class="form-group">                <label class="col-lg-3 control-label" for="edit_abattoir_owner">Pèson Respons<span class="req">*</span></label>                <div class="col-lg-5">                    <input name="edit[abattoir][owner]" id="edit_abattoir_owner" class="form-control" type="text" placeholder="Pèson Responsab" value="<?php echo array_get($edit_item, 'owner'); ?>" maxlength="20"/>                </div>            </div>            <div class="form-group">                <label class="col-lg-3 control-label" for="edit_abattoir_phone"><?php echo Lang::get('Telefòn'); ?></label>                <div class="col-lg-5">                    <input name="edit[abattoir][phone]" id="edit_abattoir_phone" class="form-control" maxlength="9" type="phone" placeholder="<?php echo Lang::get('3634-4098'); ?>" value="<?php echo array_get($edit_item, 'phone'); ?>" />                    <span class="help-inline"></span>                </div>            </div>            <div class="form-group">                <label class="col-lg-3 control-label" for="edit_abattoir_description">Remak</label>                <div class="col-lg-5">                    <textarea name="edit[abattoir][description]" id="edit_abattoir_description" rows="5" class="form-control" placeholder="Remak" maxlength="100"><?php echo array_get($edit_item, 'description'); ?></textarea>                </div>            </div>
           ...
           <legend>estimasyon abataj chak semèn</legend>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input name="edit[abattoir][bef]" id="edit_abattoir_bef" class="form-control" type="text" placeholder="Estimasyon bef" maxlength="3" value="<?php echo array_get($edit_item, 'bef'); ?>" />
                    <span class="help-inline"></span>
                </div>
            </div>

            <div class="form-group">
                <label class="col-lg-3 control-label" for="edit_abattoir_kabri">kabri</label>
                <div class="col-lg-5">
                    <input name="edit[abattoir][kabri]" id="edit_abattoir_kabri" class="form-control" type="text" maxlength="3" placeholder="kabrit" value="<?php echo array_get($edit_item, 'kabri'); ?>" />
                    <span class="help-inline"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input name="edit[abattoir][mouton]" id="edit_abattoir_mouton" class="form-control" type="text" maxlength="3" placeholder="mouton" value="<?php echo array_get($edit_item, 'mouton'); ?>" />
                    <span class="help-inline"></span>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5">
                    <input name="edit[abattoir][kochon]" id="edit_abattoir_kochon" class="form-control" type="text" maxlength="3" placeholder="kochon" value="<?php echo array_get($edit_item, 'kochon'); ?>" />
                    <span class="help-inline"></span>
                </div>
            </div>
<legend>#so Ajan ki kontwole abataj nan labatwa sa a</legend>
            <div class="form-group">
                <label class="col-lg-3 control-label" for="edit_abattoir_agent1">Ajan1</label>
                <div class="col-lg-5">
                    <select name="edit[abattoir][agent1]" id="edit_abattoir_agent1" class="form-control edit_abattoir_agents" >
                        <option value="<?php echo array_get($edit_item, 'agent1'); ?>"><?php $agent1 = Agent::find(array_get($edit_item, 'agent1'));
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label" for="edit_abattoir_agent2">Ajan2</label>
                <div class="col-lg-5">
                    <select name="edit[abattoir][agent2]" id="edit_abattoir_agent2" class="form-control edit_abattoir_agents" >
                        <option value="<?php echo array_get($edit_item, 'agent2'); ?>"><?php $agent2 = Agent::find(array_get($edit_item, 'agent2'));
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label" for="edit_abattoir_agent3">Ajan3</label>
                <div class="col-lg-5">
                    <select name="edit[abattoir][agent3]" id="edit_abattoir_agent3" class="form-control edit_abattoir_agents" >
                        <option value="<?php echo array_get($edit_item, 'agent3'); ?>"><?php $agent3 = Agent::find(array_get($edit_item, 'agent3'));
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label" for="edit_abattoir_agent4">Ajan4</label>
                <div class="col-lg-5">
                    <select name="edit[abattoir][agent4]" id="edit_abattoir_agent4" class="form-control edit_abattoir_agents" >
                        <option value="<?php echo array_get($edit_item, 'agent4'); ?>"><?php $agent4 = Agent::find(array_get($edit_item, 'agent4'));
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label" for="edit_abattoir_agent5">Ajan5</label>
                <div class="col-lg-5">
                    <select name="edit[abattoir][agent5]" id="edit_abattoir_agent5" class="form-control edit_abattoir_agents" >
                        <option value="<?php echo array_get($edit_item, 'agent5'); ?>"><?php $agent5 = Agent::find(array_get($edit_item, 'agent5'));
            ...
            <div class="form-group">
                ...
                <a href="{{URL::route('adminabbatages')}}"class="btn btn-danger">Anile</a>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(function() {
			...
			$("#edit_abattoir_bef").mask("999");
			$("#edit_abattoir_kabri").mask("999");
			$("#edit_abattoir_mouton").mask("999");
			$("#edit_abattoir_kochon").mask("999");
