            ...
            <div class="modal-body">
                <div class="">
                    <div class="form-group">
                        <label class="col-lg-2 control-label" for="notification-tag"><?php echo Lang::get('#TAG'); ?></label>
                        <div class="col-lg-10">
                            <input readonly name="notification[tag]" id="notification-tag" maxlength="50" type="text" class="form-control"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-lg-12">
                            <textarea name="notification[desc]" id="notification-desc" maxlength="50" class="form-control" placeholder="<?php echo 'Esplikasyon [50]'; ?>"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-12">
