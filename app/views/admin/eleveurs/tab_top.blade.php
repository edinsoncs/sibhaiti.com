    ...
    if ($page_id == 'eleveurs_index')
    {
        ...
        <div class="pull-right">
            <form class="navbar-form navbar-left" role="search">
                ...
                <div class="form-group">
                    <input action="{{URL::route('admineleveurs')}}" name="search" type="text" class="form-control" placeholder="Jwenn" value="<?php echo (isset($search)) ? $search : NULL ?>">
                </div>
